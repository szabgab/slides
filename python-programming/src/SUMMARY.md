...
- [shutil](./shutil/index.md)
  - [shutil module](./shutil/shutil-module.md)

- [time](./time/index.md)
  - [time module](./time/time-module.md)
  - [sleep in Python](./time/sleep-in-python.md)
  - [timer](./time/timer.md)
  - [Current date and time datetime now](./datetime/datetime-now.md)
  - [Converting string to datetime (parsing date and time string)](./datetime/converting-string-to-datetime.md)
  - [Parse datetime string with and without timezone information](./datetime/parse-datetime-string-with-and-without-timezone-information.md)
  - [datetime fromisoformat](./datetime/datetime-from-iso-format.md)
  - [date fromisoformat (only date, no time)](./datetime/date-from-iso-format.md)
  - [datetime arithmeticis (subtract)](./datetime/datetime-arithmetics-subtract.md)
  - [Timezone aware datetime](./datetime/timezone-aware-datetime.md)
  - [datetime arithmeticis (compare, sort)](./datetime/datetime-arithmetics-compare-dates.md)
  - [datetime arithmeticis (addition)](./datetime/datetime-arithmetics.md)
  - [Rounding datetime object to nearest second (removing microseconds)](./datetime/rounding-datetime-to-seconds.md)
  - [Rounding datetime object to date (removing hours, minutes, seconds)](./datetime/rounding-datetime.md)
  - [Convert datetime object to date object](./datetime/convert-datetime-to-date.md)
...
- [JSON](./json/index.md)
  - [JSON - JavaScript Object Notation](./json/json-javascript-object-notation.md)
  - [JSON dumps](./json/json-dumps.md)
  - [JSON loads](./json/json-loads.md)
  - [dump](./json/json-dump.md)
  - [load](./json/json-load.md)
  - [Round trip](./json/json-round-trip.md)
  - [Pretty print JSON](./json/pretty-print-json.md)
  - [Serialize Datetime objects in JSON](./json/serialize-datetime-objects-in-json.md)
  - [Sort keys in JSON](./json/sort-keys-in-json.md)
  - [Set order of keys in JSON - OrderedDict](./json/set-order-of-keys-in-json.md)
  - [Exercise: Counter in JSON](./json/exercise-json-counter.md)
  - [Exercise: Phone book in JSON](./json/exercise-json-phonebook.md)
