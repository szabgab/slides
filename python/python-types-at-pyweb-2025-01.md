...
{id: python-types-at-pyweb-2025-01}


## Python types at PyWeb 2025.01
{id: python-types-at-pyweb-2025-01-open}

[see the types](https://python.org.il/en/people/)


## The Answer
{id: python-types-at-pyweb-2025-01-answer}
...
## Add
{id: python-types-at-pyweb-2025-01-add}
...
## Add in function
{id: python-types-at-pyweb-2025-01-add-in-function}
...
## Complex types
{id: python-types-at-pyweb-2025-01-complex-types}
...
{id: python-types-at-pyweb-2025-01-either-this-or-that-type}
{i: Union}

* Python 3.10+

![](examples/python-types-at-pyweb-2025-01/pipe.py)
...
{id: python-types-at-pyweb-2025-01-optional-type-with-pipe}
{i: Optional}
{i: split}

![](examples/python-types-at-pyweb-2025-01/this_or_none.py)

## Define type alias
{id: python-types-at-pyweb-2025-01-define-type-alias}

![](examples/python-types-at-pyweb-2025-01/defined_type_alias.py)

## Define complex type alias
{id: python-types-at-pyweb-2025-01-define-complex-type-alias}

![](examples/python-types-at-pyweb-2025-01/defined_complex_type_alias.py)

## Define type for enum and complex dictionary
{id: python-types-at-pyweb-2025-01-define-type-for-enum}

![](examples/python-types-at-pyweb-2025-01/defined_types.py)

## mypy generics - plain
{id: python-types-at-pyweb-2025-01-mypy-generics-plain}
...
{id: python-types-at-pyweb-2025-01-mypy-generics-cannot-be-any-type}

![](examples/python-types-at-pyweb-2025-01/generics_cannot_be_any_type.py)
...
{id: python-types-at-pyweb-2025-01-mypy-generics-limit-the-types-by-listing}

![](examples/python-types-at-pyweb-2025-01/generics_limit_types_by_listing.py)

## mypy generics - limit by functionality
{id: python-types-at-pyweb-2025-01-mypy-generics}

* A more generic way to define generics is by creating types that need to have certain functionality

![](examples/python-types-at-pyweb-2025-01/generics.py)

## Two variables of the same and different types
{id: python-types-at-pyweb-2025-01-same-and-different-types}

![](examples/python-types-at-pyweb-2025-01/generics_two_types.py)
...
## mypy suggestions
{id: python-types-at-pyweb-2025-01-mypy-suggestions}
